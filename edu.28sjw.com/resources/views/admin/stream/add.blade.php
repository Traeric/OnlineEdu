...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" name="sort" id="sort" value="0">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">启用时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="datetime-local" class="input-text" name="permited_at" id="permited_at">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                ...
                <div class="radio-box">
                    <input type="radio" id="sex-3" name="status" value="2">
                    <label for="sex-3">限时禁播</label>
                </div>
            </div>
        </div>
        <div class="row cl">
