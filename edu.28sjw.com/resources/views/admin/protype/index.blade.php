    ...
    <div class="page-container">
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l">
                ...
                <a href="javascript:void(0);" onclick="admin_permission_add('添加专业分类节点','{{route("auth_add")}}','','400')" class="btn btn-primary radius">
                    <i class="Hui-iconfont">&#xe600;</i> 添加专业分类节点
                </a>
            </span>
        </div>
...
@section('js')
    ...
    <script type="text/javascript">
        $(function () {
            $("#project_category").addClass('current');
